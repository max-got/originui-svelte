...
<div class="*:not-first:mt-2">
	...
	<DateField.Root locale={localeCtx.locale}>
		<DateField.Input
			class="border-input bg-background ring-offset-background focus-within:border-ring focus-within:ring-ring/30 relative inline-flex h-9 w-full items-center overflow-hidden rounded-lg border px-3 py-2 text-sm whitespace-nowrap shadow-xs shadow-black/[.04] transition-shadow focus-within:ring-2 focus-within:ring-offset-2 focus-within:outline-hidden data-disabled:opacity-50"
		>
